...
SELECT g.gr_name AS `Name`, g.gr_temp AS `Temp` FROM groupsan g;
...
SELECT a.an_name AS `Name`, a.an_cost AS `Cost`, a.an_price AS `Price`, o.ord_datetime `Date-Time`
FROM analysis a
JOIN orders o
ON o.ord_an = a.an_id
WHERE o.ord_datetime BETWEEN '2020-02-05 00:00:01' AND '2020-02-13 00:00:01';